...
\sim
\mathcal{N}\!\left(\mathbf{0}, \mathbf{\Sigma}_a \otimes \mathbf{K}_a\right),
$$
...
$diag(\mathbf{\Psi_a})$ are close to zero in this example.

The factor-analytic can be read as a principal component analysis. Let us
scale the covariance to correlation, interpret $\mathbf{\Lambda}$ as a raw
amount of $\Sigma_{A}$ explained by each axis, and study the structure of
