...
$$
\mathbf{\tilde{a}} = \mathbf{\hat{a}}\, \mathcal{C_\mathbf{a}}^{-1},
\qquad
\mathcal{C_\mathbf{a}} = (\mathbf{\Sigma_a} - \mathbf{P_a})\, \mathbf{P_a}^{-1},
$$
...
- $\mathcal{C_\mathbf{a}}$ the coefficient of determination matrix of $\mathbf{\hat{a}}$,
- $\mathbf{P_a}$ the prediction error variance matrix of $\mathbf{\hat{a}}$.

The diagonal of $\mathcal{C_\mathbf{a}}$ can immediately
