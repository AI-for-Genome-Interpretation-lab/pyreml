...
The left-hand factor $\mathbf{\Sigma}_a$ models the covariance
...
\sim \mathcal{N}(\mathbf{0}, \mathbf{\Sigma}_{\text{a}} \otimes \mathbf{I}),
$$
...
factor $\mathbf{\Sigma}_{\text{a}}$ (across modalities of treatments) captures how
