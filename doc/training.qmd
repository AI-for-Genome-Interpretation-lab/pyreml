...
negative log-likelihood [@simchoni_integrating_2023], restricted (REML) as to yield unbiased estimates of the variance
...
the AIC method is consigned as `AIC_meth`. 
...
the construction of the inverse of $\mathbf{K_a}$ can be broken down as a
...
Given the dimensional rule, and that $\mathbf{K_a}$ is
