...
as it is approximated by the form
$\mathbf{\Sigma_a} \approx \mathbf{Q_a}\mathbf{\Lambda_a}\mathbf{Q_a}^\top + \mathbf{\Psi_a}$,
...
matrix $\mathbf{P}$ is cheaper than inverting the $n \times n$ matrix
